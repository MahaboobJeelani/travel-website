      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <h3 className="text-2xl font-bold mb-4">TripNest</h3>
            <p className="text-gray-400 mb-4 leading-relaxed">
              {COMPANY_INFO.description}
            </p>
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/profile.php?id=61583443868345" target='_blank' className="text-gray-400 hover:text-white transition duration-300 transform hover:scale-110">
                <FaFacebook size={20} />
              </a>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm flex items-center">
            © {new Date().getFullYear()} TripNest. Made with <FaHeart className="text-red-500 mx-1" /> for travelers.
          </p>
